                ...
                <td @click.stop class="actions">
                    ...
                    <transition name="fade">
                        <div v-if="actionsOpened[template.id]"
                            ...
                            <svg v-if="$page.props.auth.user.permissions.includes('staff.template.edit')" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg v-if="$page.props.auth.user.permissions.includes('staff.template.delete')" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
